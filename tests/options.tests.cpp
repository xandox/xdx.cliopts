...
TEST(xdx_cliopts_options_tests, empty_list) {
    ...
    builder.argument_list<std::string>('f', "file"sv, "some argument"sv, true, "FILE"sv);
    builder.argument<int>('a', "arg"sv, "some argument"sv);
    builder.argument<int>('b', "some argument"sv);
    builder.argument<int>('c', "C"sv, "some int value"sv, 10);
